...
#ifndef __mixr_ighost_cigi_OtwModel_H__
#define __mixr_ighost_cigi_OtwModel_H__
...
public:
    ...
    virtual void initialize(models::Player* const p, const Otm** const otwModelTable = nullptr, const int numModels = 0);
