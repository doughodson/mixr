...
namespace models {
class IAirVehicle; class Building; class IEffect; class IGroundVehicle; class LifeForm;
...
private:
   ...
   bool setEffectData(CigiModel* const, const int entity, const models::IEffect* const);
