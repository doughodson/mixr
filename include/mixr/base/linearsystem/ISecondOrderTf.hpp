...
#ifndef __mixr_linearsystem_ISecondOrderTf_HPP__
#define __mixr_linearsystem_ISecondOrderTf_HPP__
...
//
//------------------------------------------------------------------------------
class ISecondOrderTf : public IDiffEquation
{
   DECLARE_SUBCLASS(ISecondOrderTf, IDiffEquation)

public:
   ISecondOrderTf();
   ISecondOrderTf(const unsigned int rate,
