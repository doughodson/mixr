...
#ifndef __mixr_models_common_LaeroModel_HPP__
#define __mixr_models_common_LaeroModel_HPP__

#include "mixr/models/common/dynamics/AerodynamicsModel.hpp"
...
//------------------------------------------------------------------------------
class LaeroModel final: public AerodynamicsModel
{
