...
#ifndef __mixr_models_common_IWorldModel_HPP__
#define __mixr_models_common_IWorldModel_HPP__
...
// Class: IWorldModel
//
// Description: Interface that defines a model of the spatial world in terms of earth model, coordinates,
//              lat/long, etc.
//
//
// Slots --
...
//
//------------------------------------------------------------------------------
class IWorldModel : public simulation::ISimulation
{
    DECLARE_SUBCLASS(IWorldModel, simulation::ISimulation)
