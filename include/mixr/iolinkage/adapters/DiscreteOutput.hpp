...
#ifndef __mixr_iolinkage_DiscreteOutput_H__
#define __mixr_iolinkage_DiscreteOutput_H__
...
//------------------------------------------------------------------------------
class DiscreteOutput : public iolinkage::AbstractAdapter
{
   DECLARE_SUBCLASS(DiscreteOutput, iolinkage::AbstractAdapter)
