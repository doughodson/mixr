...
#ifndef __mixr_iolinkage_AnalogOutput_H__
#define __mixr_iolinkage_AnalogOutput_H__
...
//
//------------------------------------------------------------------------------
class AnalogOutput : public iolinkage::AbstractAdapter
{
   DECLARE_SUBCLASS(AnalogOutput, iolinkage::AbstractAdapter)
