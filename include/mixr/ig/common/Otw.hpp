...
#ifndef __mixr_ig_Otw_H__
#define __mixr_ig_Otw_H__
...
public:
    ...
    bool setMaxModels(const unsigned int);                           // Sets the max number of active, in-range player/models
    bool setMaxElevations(const unsigned int);                       // Sets the max number of player terrain elevation requests
