...
#ifndef __mxrp_models_TrackManager_H__
#define __mxrp_models_TrackManager_H__
...
protected:
   static const unsigned int MAX_TRKS = MXRP_CONFIG_MAX_TRACKS;         // Max tracks
   static const unsigned int MAX_REPORTS = MXRP_CONFIG_MAX_REPORTS;     // Max number of reports
