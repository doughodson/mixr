...
#ifndef __mxrp_interop_common_NetIO_H__
#define __mxrp_interop_common_NetIO_H__
...
//    static const unsigned int MAX_NETWORD_ID = 2;
    ...
    static const unsigned int MAX_NEW_OUTGOING = MXRP_CONFIG_MAX_NETIO_NEW_OUTGOING;
...
protected:
   ...
   static const int MAX_OBJECTS = MXRP_CONFIG_MAX_NETIO_ENTITIES;
...
private:  // Ntm related private
   static const unsigned int MAX_ENTITY_TYPES = MXRP_CONFIG_MAX_NETIO_ENTITY_TYPES;
