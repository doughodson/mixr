...
IAerodynamics* AirVehicle::getAerodynamicsModel()
{
   return dynamic_cast<IAerodynamics*>( getDynamicsModel() );
}

const IAerodynamics* AirVehicle::getAerodynamicsModel() const
{
...
{
   double value {};
   const IAerodynamics* aero {getAerodynamicsModel()};
   if (aero != nullptr) {
      value = aero->getGload();
   }
   return value;
...
{
   IAerodynamics* aero {getAerodynamicsModel()};
   if (aero != nullptr) {
